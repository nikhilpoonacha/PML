...
#Data variables
training.file   <- '~/R program files/Practical Machine Learning assignment/pml-training.csv'
test.cases.file <- '~/R program files/Practical Machine Learning assignment/pml-testing.csv'
